...
<div class="w3-card-4">
    ...
    <form method="post" class="w3-selection w3-light-grey w3-padding" action="./registration">
        <label>Login:
            <input type="text" name="newLogin" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
        </label>
        <label>Password:
            <input type="password" name="newPassword" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
        </label>
